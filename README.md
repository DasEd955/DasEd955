...
Builder at the intersection of software, capital, and property. I ship production code by day, underwrite deals and portfolios on the side, and treat every venture as a systems problem worth solving from first principles.

🎓 Penn State CS | 💼 Associate Software Developer, IBM Financial Services | 🚀 Founder, two ventures generating $150k+ combined revenue since age 18 | 🏠 PA Licensed Real Estate Salesperson
...
**Manage capital.** A diversified personal brokerage, roughly $107k, split between broad market exposure (VOO) and concentrated bets in tech and defense. It has outperformed the S&P 500 by approximately 163% over the past three years. I hold a PA real estate license so I understand the assets behind the analytics, not just the spreadsheets.
...
🔹 **tunerdesign-gpt** - GPT architecture built from scratch in PyTorch, transformer internals implemented by hand, not imported

🔹 **NodeSignal Messenger** - C-based TCP messenger, select()-based I/O multiplexing, 1,000+ concurrent clients

🔹 **RAG Housing Experience Analytics Engine** - Hybrid BM25 and semantic retrieval pipeline analyzing off-campus housing sentiment across Reddit, forums, and review platforms
...
- CodePath x Anthropic AI/ML Fellow
- Handshake SWE Specialist Fellow
- NVIDIA Developer Program
- PA Licensed Real Estate Salesperson
- FAA Private Pilot License (in progress)

## 📚 Currently Exploring

* Applied game theory for quantitative trading
* Advanced RAG architectures and agentic workflows
* Real estate investment analytics at scale
* Aviation systems and flight fundamentals

## 📫 Connect

📧 info@tunerdesign.org

"Build the thing yourself first. Then you actually know what you're talking about."
